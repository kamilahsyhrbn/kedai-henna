    ...
    <div class="container container-fluid">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 col-md-8 col-sm-1 text-center">
                <h2 class="my-4">Kontak Kami</h2>
                <div class="content-container">
                    <p>Katakan Halo, kirimkan pemikiran Anda tentang produk kami atau bagikan ide Anda dengan tim kami!
                    </p>
                    <div>
                        <a href="https://api.whatsapp.com/message/EOYI6BSI5OFLL1?autoload=1&app_absent=0"
                            target="_blank">
                        ...
                        <a class="mx-5" href="https://www.instagram.com/kedaihenna/" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
