...
if (isset($_POST['button-submit'])) {
    ...
    if (!in_array($fileType, $allowedExtensions)) {
        ...
        if (move_uploaded_file($file["tmp_name"], $targetFile)) {
            mysqli_query($conn, "INSERT INTO tb_produk VALUES (
                null,
                '" . $nama . "',
                '" . $harga . "',
                '" . $status . "',
        ...
        <div>
            <div class="position-relative w-100 d-grid py-2 ps-4">
                <div class="shadows position-relative p-3 rounded-4 bg-body">
                    <div>
                        <h2 class="fw-semibold text-center mt-2">Tambah Produk</h2>
                    </div>
                </div>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class=" row">
                            <div class="col-lg-8">
                                ...
                                <div class="form-floating mb-2">
                                    <input type="number" class="form-control" id="stokProduk" placeholder="Stok" min="1"
                                        name="stok" required>
                            ...
                            <div class="col-lg-4">
                                <label
                                    ...
                                    <div class="upload-container">
                                        ...
                                        <input type="file" id="file" onchange="previewImage()" name="foto" required>
